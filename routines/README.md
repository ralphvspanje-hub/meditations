...
Reference example: [random-observation.md](random-observation.md) — a daily push that picks one old observation and DMs it via Telegram. Read-only on the repo, send-only on the messenger.
